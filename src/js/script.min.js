...
const element = document.getElementById("animated-text"),
  words = ["Enzo Di Giovanni.", "un d\xe9veloppeur !", "un passionn\xe9 !"];
...
function updateText() {
  ...
  if (isDeleting)
    ...
    (isDeleting = !0), setTimeout(updateText, 1500);
    return;
  }
  setTimeout(updateText, isDeleting ? 100 : 50);
}
...
window.addEventListener("scroll", () => {
  sections.forEach((e) => {
    if (scrollY >= e.offsetTop - navHeight) {
      let t = document.querySelector(".nav-link.active");
      t && t.classList.remove("active");
      let o = document.querySelector(".nav-link[href='#" + e.id + "']");
    ...
    e.addEventListener("click", async function () {
      ...
      try {
        await navigator.clipboard.writeText(e),
          alert("Texte copi\xe9 dans le presse-papiers: " + e);
      } catch (t) {
        console.error("Erreur lors de la copie : ", t);
      }
    });
  });
